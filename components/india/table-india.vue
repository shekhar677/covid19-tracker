  ...
  <div class="bg-white rounded-card shadow-sm p-1 sm:p-4 md:p-10 md:pb-5 py-6 md:m-3 mt-6 relative">
    <div v-if="tableData" class="flex flex-col">
      <div class="flex bg-white justify-between w-full mb-1 sm:pl-4 sticky top-0">
        <p class="text-xs2 sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 uppercase text-center sm:text-left">State</p>
        ...
        <div v-if="table.visible" class="bg-grey p-2 sm:p-3 sm:px-4 sm:ml-3 rounded-md border border-grey-100">
          ...
          <div class="mt-3" v-if="currentDistrict">
            ...
            <div class="flex justify-between w-full mb-1 sm:pl-4">
              <p class="text-xxs sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 sm:text-left text-center uppercase">District</p>
              <p class="text-xxs sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 sm:text-left text-center uppercase">Confirmed</p>
              <p class="text-xxs sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 sm:text-left text-center uppercase">Active</p>
              <p class="text-xxs sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 sm:text-left text-center uppercase">Recovered</p>
              <p class="text-xxs sm:text-xs font-semibold text-grey-200 self-start w-full p-1 sm:p-2-5 sm:text-left text-center uppercase">Deaths</p>
            </div>
            <div v-for="(district, i) in currentDistrict[0].districtData" :key="i" class="flex flex-col items-start">
              <n-link :to="'/india/'+table.state+'/'+district.district" class="w-full">
