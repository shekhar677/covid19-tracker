<template>
  <div>
    <div v-if="currentDistricts" class="bg-white dark-mode:bg-black-lighter relative rounded-card shadow-sm p-1 sm:p-4 md:p-10 md:pb-5 py-6 md:m-3 mt-6">
      <div>
        <h1 class="text-black dark-mode:text-grey-50 text-base px-1 sm:text-xl font-semibold text-center sm:text-left">Districts</h1>
        <div class="p-1 sm:p-3 sm:px-4 rounded-md w-full relative">
          <div class="mt-3">
            <div class="flex bg-white dark-mode:bg-black-lighter justify-between w-full mb-1 sm:pl-4 sticky top-0">
              <p class="text-xs2 sm:text-xs font-semibold text-grey-200 dark-mode:text-grey-50 self-start w-full p-1 sm:p-2-5 uppercase">District</p>
              <p class="text-xs2 sm:text-xs font-semibold text-grey-200 dark-mode:text-grey-50 self-start w-full p-1 sm:p-2-5 uppercase">Confirmed</p>
              <p class="text-xs2 sm:text-xs font-semibold text-grey-200 dark-mode:text-grey-50 self-start w-full p-1 sm:p-2-5 uppercase">Active</p>
              <p class="text-xs2 sm:text-xs font-semibold text-grey-200 dark-mode:text-grey-50 self-start w-full p-1 sm:p-2-5 uppercase">Recovered</p>
              <p class="text-xs2 sm:text-xs font-semibold text-grey-200 dark-mode:text-grey-50 self-start w-full p-1 sm:p-2-5 uppercase">Deaths</p>
            </div>
            <div v-for="(district, i) in currentDistricts" :key="i">
              <div class="select-none flex justify-start items-center w-full bg-grey-50 dark-mode:bg-black hover:shadow-md cursor-pointer sm:pl-4 my-1 rounded-md">
                <div class="flex items-center w-full">
                  <p class="text-xs text-black dark-mode:text-grey-50 w-20 sm:w-32 font-semibold self-start p-1 sm:p-2-5 py-1 sm:pl-2">{{ district.district }}</p>
                </div>
