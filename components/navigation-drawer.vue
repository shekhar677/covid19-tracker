      ...
      <div class="flex sm:flex-col justify-around h-8 sm:min-h-2/5 sm:min-w-0 min-w-full sm:mt-6">
        <n-link to="/" class="flex items-center">
          <div class="flex items-center justify-center">
            ...
            <p class="hidden sm:block ml-4 text-black text-base font-semibold tran-opacity" :class="{ 'opacity-0': (drawer == false) }">Statistics</p>
          </div>
        </n-link>
        <n-link to="/symptoms" class="flex items-center">
          <div class="flex items-center justify-center">
            ...
            <p class="hidden sm:block ml-4 text-black text-base font-semibold tran-opacity" :class="{ 'opacity-0': (drawer == false) }">Symptoms</p>
          </div>
        </n-link>
        <n-link to="/prevention" class="flex items-center">
          <div class="flex items-center justify-center">
            ...
            <p class="hidden sm:block ml-4 text-black text-base font-semibold tran-opacity" :class="{ 'opacity-0': (drawer == false) }">Prevention</p>
          </div>
        </n-link>
        <n-link to="/treatment" class="flex items-center">
          <div class="flex items-center justify-between">
            ...
            <p class="hidden sm:block ml-4 text-black text-base font-semibold tran-opacity" :class="{ 'opacity-0': (drawer == false) }">Treatment</p>
          </div>
        </n-link>
      </div>
    </div>
