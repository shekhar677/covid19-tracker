<template>
  <div class="drawer shadow z-20 bg-black sm:bg-grey text-black sm:border-r sm:border-grey-100 w-full h-14 sm:h-screen overflow-hidden fixed bottom-0 sm:top-0 sm:left-0" :class="{ 'sm:w-20': !drawer, 'sm:w-48': drawer }">
    <div class="h-full flex flex-shrink sm:flex-col sm:items-start items-center select-none px-5">
      ...
      <div class="flex sm:flex-col justify-around h-8 sm:min-h-2/5 sm:min-w-0 min-w-full sm:mt-10">
